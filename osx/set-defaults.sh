...
# Enable Application Expose gestion
...
# Set Safari’s home page, new tab, new window to `about:blank` for faster loading
...
# Hide Safari's favorites in smart search field
defaults write com.apple.Safari ShowFavoritesUnderSmartSearchField -bool false

# Disable top hit preload in smart search field
